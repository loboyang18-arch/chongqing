...
from src.model_v16d_hourly_settlement import (
    train_one, predict_test,
    TARGET_DA_CLEARING, SEQ_TARGET_COL, C_POINT,
)
from price_forecast_eval.viz import run_standard_visualization
from src.model_v16_nhits import (
    build_feature_matrix, TRAIN_END,
    HIST_COLS, FUTR_COLS,
)
...
fit_mask_eng = feat_da.index <= TRAIN_END
...
p24, a24, dates = predict_test(
    ...
    model_kw=MODEL_KW, seq_y_norm=seq_y_norm, **eng_kw,
)
rows = []
